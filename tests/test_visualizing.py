...
def test_run_with_no_random_colors(mock_plt_show, bus_jpg, weights_file):
    _ = mock_plt_show
    result = detecting.run(bus_jpg, YOLO(weights_file), "cpu")
    labeled_image = visualizing.run(
        result.instances,
...
def test_run_with_opaque_mask_color(mock_plt_show, bus_jpg, weights_file):
    _ = mock_plt_show
    result = detecting.run(bus_jpg, YOLO(weights_file), "cpu")
    labeled_image = visualizing.run(
        result.instances,
...
def test_run_with_tiles(mock_plt_show, bus_jpg, weights_file):
    _ = mock_plt_show
    result = detecting.run(bus_jpg, YOLO(weights_file), "cpu")
    labeled_image = visualizing.run(
        result.instances,
...
def test_run_with_show_classes(mock_plt_show, bus_jpg, weights_file):
    _ = mock_plt_show
    result = detecting.run(bus_jpg, YOLO(weights_file), "cpu")
    labeled_image = visualizing.run(
        result.instances,
